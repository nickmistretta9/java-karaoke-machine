...
public class KaraokeMachine {
  ...
  private String promptAction() throws IOException {
    System.out.printf("There %d songs available and %d in the queue. Your options are: %n", mSongBook.getSongCount(), mSongQueue.size());
  ...
  public void playNext() {
    ...
    if(song == null) {
      ...
      System.out.printf("%n%n Open %s to hear %s by %s %n%n%n", song.getVideoUrl(), song.getTitle(), song.getArtist());
    }
